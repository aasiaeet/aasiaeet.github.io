...
![scoreboard]({{ site.url }}{{ site.baseurl }}/assets/images/scoreboard.jpg){: width="300px"}
...
31. Here are my background section's subsections: 
	a) Previous training: Who am I? How did I get into data science? 
	b) The turning point: Why I got into cancer study? 
	c) Ongoing training: What have I been doing during my postdoc? (You probably don't have published papers, so clearly explain what you have done) 
	d) Forging a career path: How did I come up with the proposed project? 
32. Here are my career development section's subsections: First, what is your goal? Are you committed to cancer research? 
	a. Collaboration and progress evaluation: introduce your mentors and their area of expertise and also your collaborators and scientific advisory committee, don't repeat the information that you have in other parts of your application. 
	b. Enhancing my research skill: where I had 
		i) formal coursework in cancer biology; 
		ii) skill improvement in relevant technical areas; 
		iii) seminars and conferences: include specific conferences with their names, dates, and places. 
		iv) lab meetings and discussion groups; 
		v) online courses: I have been watching a lot of lectures online, and I thought it is cool to include that. 
	c. Writing, presentation, grantsmanship, and critical assessment skills: Where do you learn to write grants? How do you improve your writing and presentation skills? How do you become a reviewer or panelist? 
	d. Supervisory, mentoring and teaching skills: Have you taught a course? Are you going to? Will you prepare a teaching statement? Have you managed/mentored undergrad and grads? Will you? Where do you learn from to do so? 
	e. Leadership and laboratory management: How do you learn to manage projects and lead a lab? What technology you are using or willing to learn to use for online communication, collaboration, project management, and software development? 
	f. Transition to independence: When will you be on the job market? Can you take your research with you? Why should we believe that there is a market for your expertise? What will your future lab work on? 
